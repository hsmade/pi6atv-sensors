...
sensor_config = [
    ...
    BooleanSensor(name="Door closed", gpio_pin=9),
    FanSensor(name="60 °C", gpio_pin=22, minimum=1500, maximum=2100, sort=1),
    FanSensor(name="50 °C", gpio_pin=27, minimum=1500, maximum=2100, sort=2),
    FanSensor(name="40 °C", gpio_pin=17, minimum=1500, maximum=2100, sort=3),
    FanSensor(name="Cpu",   gpio_pin=7,  minimum=1500, maximum=2100),
    DS18B20TemperatureSensor("RM", "28-0417c475edff", sort=1),
    DS18B20TemperatureSensor("MP", "28-0173ca070002", sort=2),
    ...
    DS18B20TemperatureSensor("PSUs", "28-0417018ae3ff", sort=6),
    DHT22TemperatureSensor("RM", "/sys/bus/iio/devices/iio:device0/"),
