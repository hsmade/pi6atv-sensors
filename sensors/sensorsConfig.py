...
sensor_config = [
    ...
    DS18B20TemperatureSensor("PA temperature", "00-2a8000200042"),
    DS18B20TemperatureSensor("Mounting plate temperature", "00-aa8000200042"),
    # DS18B20TemperatureSensor("Room temperature", "00-d20000200042"),
